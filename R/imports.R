#' @title Import clustering results generated by automatic gating algorithms
#'
#' @description
#' The 'importResult()' function imports cell clustering results from two dataframes ('cluster.abundances' and 'cluster.phenotypes').
...
#' @param th.min_cells a numeric specifying the minimum number of cell in a cluster of a sample to take in account its phenotype
#'
...
#'
#' @param SPADEResult a SPADEResult object
#'
